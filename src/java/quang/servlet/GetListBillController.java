 ...
 * @author Admin
 */
public class GetListBillController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (username != null) {
                ...
                if (admin.getRole() != 0) {
                    url = CommonFinalString.LIST_BILL_PAGE;
                    BillDAO dao = new BillDAO();
                    request.setAttribute("listBills", dao.getListBill());
                }
            } else {
                url = CommonFinalString.LOGIN_PAGE;
            }
        } catch (ClassNotFoundException ex) {
            Logger.getLogger(GetListBillController.class.getName()).log(Level.SEVERE, null, ex);
