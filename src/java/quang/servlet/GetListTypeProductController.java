 ...
 * @author Admin
 */
public class GetListTypeProductController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        String url = CommonFinalString.LIST_TYPE_PRODUCT_PAGE;
        try {
            ...
            Logger.getLogger(GetListTypeProductController.class.getName()).log(Level.SEVERE, null, ex);
        } finally {
