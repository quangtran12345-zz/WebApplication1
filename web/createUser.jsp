<%-- 
    Document   : signUp
    Created on : Aug 13, 2019, 3:48:59 PM
    Author     : Admin
--%>
            ...
            <div class="p-5">
              <div class="text-center">
                ...
                <div class="form-group">
                  <input type="text" class="form-control form-control-user" name="username" value="${param.username}" id="exampleInputEmail" placeholder="Username">
                </div>
                <div class="form-group row">
                  <div class="col-sm-6 mb-3 mb-sm-0">
                  ...
                  <div class="col-sm-6">
                    ...
                    <% } %>
                    <button class="btn btn-primary btn-user btn-block" name="action" value="CreateUser">
                  Register Account
                </button>
                <!--<hr>-->
